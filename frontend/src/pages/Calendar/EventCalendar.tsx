...
const EventCalendar: React.FC<EventTrigger> = ({
  open,
  onOpenChange,
  onCloseChange,
  selectedEvent,
  ...
  return (
    <>
      ...
      >
        <DialogContent
          className="flex flex-col custom-scrollbar min-w-[600px] max-h-[100vh] overflow-y-auto [&>button]:hidden"
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className={`flex space-x-2 space-y-0 mr-4`}>
                <p className="flex items-center bg-zinc-100 px-3 p-1 border rounded-md h-8 text-[12px] text-center">
                  {formattedEvent?.startTime} - {formattedEvent?.endTime}{' '}
                  {formattedEvent?.date} ({formattedEvent?.duration})
                </p>
              </div>
              <div
                  ...
                  <div className="flex items-center space-y-0 bg-white shadow-sm px-2 border rounded-md h-8">
                    ...
                    <div>
                      {selectedEvent?.dueDate ? (
                        ...
                        <div className="px-1 text-gray-500 md:text-[12px] cursor-pointer">
                          No due date
                        </div>
                      )}
                    </div>
