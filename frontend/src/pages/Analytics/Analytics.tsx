...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="bg-indigo-50 p-4 w-full min-h-screen">
      {/* Main Container */}
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex flex-col lg:w-1/3 gap-4">
          ...
          <div className="flex flex-col bg-white p-4 rounded-md shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
              <div className="flex flex-col items-center bg-gray-100 p-2 rounded-md shadow-sm">
              ...
              <div className="flex flex-col items-center bg-gray-100 p-2 rounded-md shadow-sm">
                ...
                <p className="text-sm">Completed Pomodoros</p>
              </div>
              <div className="flex flex-col items-center bg-gray-100 p-2 rounded-md shadow-sm">
                ...
                <p className="text-sm">Pomodoros Remaining</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white p-4 rounded-md shadow-md">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center">
                <BsListTask className="mr-2 text-blue-500" size={20} />
                <p className="font-semibold text-lg">Task Status</p>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center ml-2 hover:cursor-pointer">
              ...
              <div className="flex space-x-2">
                {/* Calendar Button */}
                <button
                  className="flex items-center bg-indigo-500 text-white px-3 py-1 rounded-md hover:bg-indigo-600 transition text-sm"
                  ...
                  <DialogContent className="flex flex-col space-y-4">
                    ...
                    {taskStatusCounts ? (
                      <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col space-y-2 p-2 rounded-md w-full h-48 overflow-y-auto bg-gray-50">
              ...
              {isCalendarVisible && (
                <div className="absolute top-16 right-4 z-50 bg-gray-50 shadow-md p-2 border rounded-md w-72 sm:w-80 lg:w-96">
                  <DayPilotNavigator
                    selectMode={'Week'}
                    showMonths={1}
                    skipMonths={1}
        ...
        <div className="flex flex-col lg:w-2/5 gap-4">
          ...
          <div className="flex bg-white p-4 rounded-md shadow-md flex-1">
            <h3 className="font-semibold text-lg mb-4">Weekly Task Counts</h3>
            {weeklyTaskCounts ? (
          ...
          {/* Pomodoro Analytics */}
          <div className="flex bg-white p-4 rounded-md shadow-md flex-1">
            <h3 className="font-semibold text-lg mb-4">Pomodoro Analytics</h3>
            {pomodoroAnalytics ? (
