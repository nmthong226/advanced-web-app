                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-col justify-start space-y-2 custom-scrollbar p-2 rounded-md w-full h-[200px] overflow-y-auto">
                      ...
                      <ul className="flex flex-col space-y-1 pl-5 text-[12px] list-disc">
                        <li>
                          Pending Tasks: With 8 pending tasks (34.78%), it's
                          important to prioritize these to avoid bottlenecks and
                          ensure smooth workflow progression.
                        </li>
                        <li>
                          Completed Tasks: Having 10 completed tasks (43.48%) is
                          a positive sign of productivity. However, there's room
                          for improvement to increase the completion rate.
                        </li>
                        <li>
                          In-Progress Tasks: 5 tasks (21.74%) are currently in
                          progress, indicating steady work. Ensuring these tasks
                          are completed soon will help reduce the pending load.
                        </li>
                      </ul>
                      <h5 className="flex items-center gap-1 font-mono font-semibold text-sm">
                      ...
                      <ul className="flex flex-col flex-1 space-y-1 pl-5 text-[12px] list-disc">
                        ...
                        <li>
                          Maintain the momentum of completed tasks to stay on
                          track with goals.
                        </li>
                      </ul>
                    </div>
