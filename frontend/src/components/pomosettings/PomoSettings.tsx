...
const PomoSettings: React.FC<PomoSettingsProps> = ({
  ...
  function playAlarmSoundPreview(soundAlarm: string): void {
    throw new Error('Function not implemented.');
  }

  function playBreakSoundPreview(soundBreak: string): void {
    throw new Error('Function not implemented.');
  }
          ...
          {isLoading ? (
            ...
            <Tabs defaultValue="timer" className="w-full">
              ...
              <TabsContent value="timer">
                <div className="flex flex-col my-5 px-1 w-full">
              ...
              <TabsContent value="sound">
                <div className="flex flex-col my-3 px-4 w-full">
                  <div className="flex flex-col justify-between space-y-3 w-full">
                    <div className="flex justify-between items-center w-[75%]">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          type="button"
                          onClick={() => playAlarmSoundPreview(soundAlarm)}
                    ...
                    <div className="flex justify-between items-center w-[75%]">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          type="button"
                          onClick={() => playBreakSoundPreview(soundBreak)}
                          className="ml-2 p-1 bg-gray-200 rounded-md hover:bg-gray-300 transition"
