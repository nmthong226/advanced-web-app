...
const AIFeedback = () => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-white w-full h-full">
      <div className="flex flex-col space-y-2 custom-scrollbar p-4 border rounded-lg w-full h-[92%] text-xs overflow-y-auto">
      ...
      <div className="flex justify-between space-x-2 w-full h-[8%]">
        <button
