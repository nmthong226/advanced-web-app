    ...
    return (
        ...
        >
            <div className="flex rounded-sm font-semibold text-gray-700 text-nowrap dark:text-gray-200">
                <p
                    className={`${isToday ? 'bg-indigo-600 text-white' : ''
                        } px-1 rounded-md text-[11px] ${day.getDate() === 1
            ...
            <div
                className={cn(
                    'relative flex flex-col gap-[1px] custom-scrollbar',
            ...
            >
                ...
                {hiddenChildrenCount > 0 && !isClicked && (
                    <div
                        className="text-[12px] text-center hover:text-indigo-600 hover:cursor-pointer"
                        onClick={() => setIsClicked(!isClicked)} // Toggle click state on click
                    >
