...
const Settings = () => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="flex gap-0 bg-[#F7F7F7] dark:bg-slate-700 p-0 sm:rounded-xl max-w-[880px] h-[600px]" bgOverlay='bg-black/60 dark:bg-black/80' >
                {/* Sidebar */}
                <div className="flex flex-col bg-white dark:bg-slate-800 rounded-r-none rounded-xl w-[25%]">
                    ...
                    <div className="flex flex-col space-y-1 p-3">
                        ...
                        >
                            ...
                            <p className={`font-medium text-[12px] text-left`}>Subscription</p>
                        </button>
                    </div>
                </div>
                {/* Content Area */}
                    ...
                    {activeTab === 'Subscription' && (
                        <div className='flex flex-col p-1'>
                            ...
                            <div className='flex justify-between items-center bg-gray-50 dark:bg-slate-600 p-3 border rounded-xl w-full h-20'>
                                <div className='flex flex-col'>
                                    <p className='font-semibold text-indigo-600 text-xl dark:text-yellow-200'>Chill Plan</p>
                                    <hr className='border-t-[1px] w-48' />
                                    <p className='text-[12px] text-muted-foreground dark:text-white'>Serve you with our basic features. </p>
                                </div>
                                ...
                                <Dialog open={nestedDialogOpen} onOpenChange={setNestedDialogOpen}>
                                    <DialogContent className="bg-white dark:bg-slate-800 p-6 rounded-xl md:max-w-[600px] h-[440px]" bgOverlay='bg-black/20'>
                                        <DialogHeader>
                                            ...
                                            <p className='text-[12px] text-muted-foreground'>Do more with advanced AI integration, customization features</p>
                                            <div className='flex space-x-6 py-2 w-full h-[340px]'>
                                                <div className='flex-col space-y-4 w-[40%]'>
                                                    <div className='flex flex-col space-y-2'>
                                                        ...
                                                        <Input defaultValue={"Nguyễn Minh Thông"} disabled className='border-gray-600 bg-gray-200 border w-full h-10' />
                                                    </div>
                                                    <div className='flex flex-col space-y-2'>
                                                        <Label htmlFor="name" className='font-normal'>
                                                            Bill Options
                                                        ...
                                                        <RadioGroup defaultValue="option-one" className='space-y-2'>
                                                            <div className="flex items-center space-x-2 px-2 border rounded-md h-10">
                                                                ...
                                                                <div className='flex flex-col'>
                                                                    <Label htmlFor="option-one" className='font-normal'>Pay monthly</Label>
                                                                    <p className='text-[12px] text-muted-foreground'>$10 / month</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex justify-between items-center space-x-2 px-2 border rounded-md h-10">
                                                                <div className='flex items-center space-x-2'>
                                                                    ...
                                                                    <div className='flex flex-col'>
                                                                        <Label htmlFor="option-two" className='font-normal'>Pay annually</Label>
                                                                        <p className='text-[12px] text-muted-foreground'>$8 / month</p>
                                                                    </div>
                                                                </div>
                                                                <div className='flex items-center space-x-2'>
                                                                    <p className='text-[12px] text-emerald-600'>Save 20%</p>
                                                                </div>
                                                            </div>
                                                        </RadioGroup>
                                                    </div>
                                                    ...
                                                    <div className='flex flex-col space-y-2'>
                                                        ...
                                                        <RadioGroup defaultValue="option-one" className='flex mt-2'>
                                                            <div className="flex items-center space-x-2 px-2 border rounded-md w-1/2 h-10">
                                                                <RadioGroupItem value="option-one" id="option-one" />
                                                                <div className='flex flex-col'>
                                                                    <Label htmlFor="option-one" className='font-normal'>Credit Card</Label>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center space-x-2 px-2 border rounded-md w-1/2 h-10">
                                                                <div className='flex items-center space-x-2'>
                                                                    <RadioGroupItem value="option-two" id="option-two" />
                                                                    <div className='flex flex-col'>
                                                                        <Label htmlFor="option-two" className='font-normal'>E-wallet</Label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </RadioGroup>
                                                    ...
                                                    <div className='flex flex-col space-y-4'>
                                                        <div className='flex flex-col space-y-2'>
                                                            ...
                                                            <div className='relative flex items-center border rounded-md w-full h-10'>
                                                                <Input placeholder='Card number' className='border-none focus-visible:ring-0 w-[75%] h-10' />
                                                        ...
                                                        <div className='flex space-x-2'>
                                                            <Input placeholder='Expiration date' className='border w-1/2 h-10' />
                                                            <Input placeholder='CVC (*master card)' className='border w-1/2 h-10' />
                                                        </div>
                            ...
                            <div className='flex gap-x-4 mt-4 w-full h-full'>
                                <div className='flex flex-col bg-gray-50 shadow-lg px-5 p-3 border rounded-lg w-1/2 h-[210px]'>
                                    <div className='flex flex-col text-center leading-tight'>
                                        ...
                                        <p className='text-[12px] text-muted-foreground'>*your current plan</p>
                                    </div>
                                ...
                                <div className='flex flex-col bg-gray-50 shadow-lg px-5 p-3 border rounded-lg w-1/2 h-[400px]'>
                                    ...
                                    <ul className='space-y-2 text-[12px] text-gray-600 text-left'>
                                        ...
                                        <li className='font-semibold text-center'>and 5 more benefits</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
