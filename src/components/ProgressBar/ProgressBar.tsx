  ...
  return (
    <TooltipProvider>
      <div className="border progress-bar">
        ...
        <Tooltip>
          <TooltipTrigger
            className="bg-slate-300 dark:bg-indigo-200 border-r-[3px] progress-segment"
        ...
        <Tooltip>
          <TooltipTrigger
            className="bg-slate-400 dark:bg-indigo-700 progress-segment"
        ...
        <Tooltip>
          <TooltipTrigger
            className="border-slate-500 bg-slate-500 dark:bg-indigo-500 border-r-[3px] progress-segment"
